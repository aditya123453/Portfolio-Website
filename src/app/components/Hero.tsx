        ...
        <div className="flex-1">
          ...
          >
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-white/10 text-white bg-white/5 backdrop-blur-md hover:bg-white/10 hover:border-white/20 text-base px-10 py-7 rounded-2xl transition-all font-bold"
            >
